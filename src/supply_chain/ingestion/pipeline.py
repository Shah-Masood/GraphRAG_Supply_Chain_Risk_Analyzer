"""
Ingestion pipeline: raw document → chunks → embeddings → ChromaDB + Postgres + Neo4j.

Supports PDF files and plain text. News articles come through ingestion/news.py.
