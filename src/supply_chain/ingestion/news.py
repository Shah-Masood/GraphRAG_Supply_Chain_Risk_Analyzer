"""
NewsAPI async fetcher.

Fetches real news articles relevant to supply chain risk, normalizes them,
and pipes them through the ingestion pipeline into ChromaDB + Postgres.
...
Usage:
    ...
    doc_ids = await fetch_and_ingest_news(
        ...
        max_articles=20,
        supplier_id="uuid-...",   # optional — tags chunks to a specific supplier
